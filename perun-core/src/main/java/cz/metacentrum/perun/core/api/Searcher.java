...
public interface Searcher {
	 ...
	 * @throws PrivilegeException internal error
	 * @throws InternalErrorException insufficient permission
	 */
	List<PerunEntity> generalSearch(PerunSession sess, String query) throws PrivilegeException, InternalErrorException;
}
